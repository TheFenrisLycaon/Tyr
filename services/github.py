...
class GithubClient(object):
    ...
    def api_call(self, url):
        ...
        auth_header = {
            ...
            % base64.b64encode("%s:%s" % (self.github_username, self.pat))
        }
    ...
    def get_contributions_on_date_range(self, date_range):
        ...
        response = urlfetch.fetch(
            "https://github.com/%s?tab=overview" % self.github_username, deadline=30
        )
        if response.status_code == 200:
            ...
            for date in date_range:
                ...
                commits_on_day = bs.find("rect", {"data-date": iso_date}).get(
                    "data-count", 0
                )
