    ...
    def test_submit(self):
        volley = [
            (
                "Working - Coding",
                "Office",
                {"happiness": 10, "stress": 2},
                {"activity": "Working", "activity_sub": "Coding", "place": "Office"},
            ),
            (
                "Working: Meeting",
                "Office",
                {"happiness": 2, "stress": 4},
                {"activity": "Working", "activity_sub": "Meeting", "place": "Office"},
            ),
            (
                "Running",
                "Track",
                {"happiness": 10, "stress": 1},
                {"activity": "Running", "activity_sub": None, "place": "Track"},
            ),
        ]
        for v in volley:
            ...
            sn.put()
            for key, val in list(expected_vals.items()):
                self.assertEqual(getattr(sn, key), val)
            for metric, val in list(metrics.items()):
