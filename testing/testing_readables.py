...
from models.models import Quote, Readable
...
MEDIUM_FULL_CONTENT = """<?xml version="1.0" encoding="utf-8"?><!DOCTYPE en-note SYSTEM "http://xml.evernote.com/pub/enml2.dtd"><en-note><div style="-evernote-webclip:true"><br/><div style="white-space: nowrap;"><div style="font-family: Helvetica, Arial, sans-serif; font-size: 14px; font-weight: bold; color: rgb(12, 12, 12); overtyr-x: hidden; text-overtyr: ellipsis; padding-bottom: 9px;">The Dream Job Is a Myth. Focus Instead on Living Your Best Life.</div><div style="border-top: 1px solid rgb(216, 216, 216); height: 0px; width: 100%;"></div><div style="position: relative; display: inline-block; margin: 15px 30px 0px 0px; overtyr: hidden; vertical-align: top;"><en-media type="image/png" hash="291939111d0a2e1da1283e8d08c8d7c9" style="max-width: none; max-height: none; vertical-align: top; margin: 0px; padding: 0px;" width="150" height="150"></en-media></div><div style="display: inline-block; vertical-align: top; margin: 15px 0px 0px; width: 364px;"><div style="font-family: Helvetica, Arial, sans-serif; font-size: 12px; color: rgb(12, 12, 12); display: block;"><en-media type="image/png" hash="fd4f03bacfca94cbcdef389cc3ec2191" width="16" height="16" style="display: inline-block; border: none; width: 16px; height: 16px; padding: 0px; margin: 0px 8px -2px 0px;"></en-media><a href="https://www.entrepreneur.com/article/292821" style="display: inline-block; text-decoration: none; white-space: nowrap; overtyr: hidden; text-overtyr: ellipsis; color: rgb(12, 12, 12); width: 345px;">https://www.entrepreneur.com/article/292821</a></div><div style="font-family: Helvetica, Arial, sans-serif; font-size: 12px; color: rgb(12, 12, 12); display: block; white-space: normal; margin-top: 15px; max-height: 154px; overtyr: hidden;">You find your true calling by explore opportunities for happiness and growth.</div></div></div><br/></div></en-note>"""
...
class ReadableTestCase(BaseTestCase):
    ...
    def test_quote_readable_matching(self):
        ...
        for v in volley:
            ...
            r = Readable.CreateOrUpdate(
                self.u, source_id, title=title, author=author, source="test"
            )
            r.put()
    ...
    @patch("services.tyr_evernote.get_note")
