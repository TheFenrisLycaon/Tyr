...
class HABIT:
    HELP = """
    You can set habits to build, and track completion. 
    Try saying 'new habit: run', 'habit progress', or 'commit to run tonight'
    """
...
class JOURNAL:
    HELP = """
    You can set up daily questions to track anything you want over time. 
    Try saying 'daily report'
    """
...
class READABLE:
    ...
    LABELS = {ARTICLE: "Article", BOOK: "Book", PAPER: "Paper"}

    LOOKUP = {"article": 1, "book": 2, "paper": 3}
...
class TASK:
    ...
    HELP = """
    You can set and track top tasks each day. Try saying 'add task remember the milk' or 'my tasks'
    """
...
class GOAL:
    HELP = """
    You can review your monthly and annual goals. Try saying 'view goals'
    """
    SET_INFO = "Bear with us as we're still in beta!"
